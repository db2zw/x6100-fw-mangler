...
FROM x6100:dl2zw-color_mod-vanilla

COPY dl2zw-color_mod-opt-alpine.Dockerfile.d/ /src/dl2zw-color_mod-opt-alpine.Dockerfile.d/
...
RUN set -e ;\
  export \
    SRC=/src/dl2zw-color_mod-opt-alpine.Dockerfile.d/ ;\
  exec \
