...
FROM x6100:dl2zw-color_mod-opt-alpine
COPY       dl2zw-color_mod-modded.Dockerfile.d/ /src/dl2zw-color_mod-modded.Dockerfile.d/
# a bit of code reuse
...
RUN set -e ;\
  export \
    SRC=/src/dl2zw-color_mod-modded.Dockerfile.d/ ;\
  exec \
