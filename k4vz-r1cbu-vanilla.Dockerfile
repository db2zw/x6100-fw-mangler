...
FROM x6100:K4VZ-R1CBU-sdcard
COPY k4vz-r1cbu-vanilla.Dockerfile.d/ /src/k4vz-r1cbu-vanilla.Dockerfile.d/

#COPY K4VZ-R1CBU-patch.tar.gz /tmp
...
RUN set -e ;\
  export \
    SRC=/src/k4vz-r1cbu-vanilla.Dockerfile.d/ ;\
  exec \
